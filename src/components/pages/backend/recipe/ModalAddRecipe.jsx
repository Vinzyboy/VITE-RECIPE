            ...
            <form action="">
              <div className="grid grid-cols-[1fr,_1.5fr,_1.5fr] gap-5">
                  ...
                  <div className="input-wrap">
                    ...
                    <div className="overflow-y-auto custom-scroll max-h-[655px] h-full pr-2">
                      {Array.from(Array(2).keys()).map((i) => (
                        <div className="grid grid-cols-[1fr,_.3fr,_.8fr,_.2fr] gap-3 mt-3">
                          <div>
                ...
                <div className="instruction">
                  <h3>Description</h3>
                  <textarea
                    className="overflow-y-auto custom-scroll max-h-[120px] p-2 h-full outline-none bg-primary text-body border border-line w-full
                  rounded-md resize-none"
                  />
                  <h3>Instruction</h3>
                  <textarea
                    className="overflow-y-auto custom-scroll max-h-[300px] p-2 h-full outline-none bg-primary text-body border border-line w-full
                  rounded-md resize-none"
                  />
                </div>
              </div>
